  ...
  render() {
    ...
    return (
      <div className="grid-container">
        {groups.map((group, id) => <ThreeByThree  key = {id} onCellHoverOut = {onCellHoverOut} onCellHover = {onCellHover} onCellClick = {onCellClick} group = {group} color = {id % 2 === 0 ? color1 : color2}/>)}
